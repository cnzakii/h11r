---
name: http11-audit
description: Audit http11 code, diffs, APIs, architecture, tests, packaging, documentation, or release surfaces for evidence-backed defects and unnecessary complexity. Use after implementation or when a read-only review is requested. Never modify files; fixes belong to http11-implementation.
---
...
4. Use `http11-knowledge` when a finding depends on an external fact. Treat
