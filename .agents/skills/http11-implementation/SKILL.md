---
name: http11-implementation
description: Implement requested changes in the http11 Rust core, PyO3 binding, Python package, tests, packaging, CI, or project documentation. Use when creating, modifying, fixing, refactoring, replacing, or migrating http11 behavior or repository files. Do not use for read-only audits or factual research.
---

# http11 Implementation
...
4. Use `http11-knowledge` when a decision depends on protocol requirements,
...
8. Review the final changes with `http11-audit`. Address blocking findings
